...
\title{
    \includegraphics[width=0.3\textwidth]{pictures/eggo_icon.jpeg}\\
    \vspace{1cm}
    \textbf{Spiegel AI}\\
    \vspace{0.5cm}
    \textbf{\large Datenverarbeitung in der Technik}\\
    \vspace{0.5cm}
    \textbf{\large Gruppe 5}\\
    \vspace{1.5cm}
}
...
\input{spiegel_ai_remote}

\input{schnittstelle}

\input{gesichtserkennung}
...
\hline
\textbf{Kalenderwoche} & \textbf{Stunden} & \textbf{Arbeit} \\
\hline
\endfirsthead
...
\hline
15 & 3 & Postererstellung \\
   & 2 & Besprechung Spiegelrahmen \\
   & 2 & Detallierung der CAD Datei \\
\hline
...
17 & 4 & Weitere Setup für Display Programmierung \\
   & 6 & Projekt Besprechung und weitere Programmierung \\
\hline
18 & 2 & Display Programmierung (Fertigstellung Verkehrs Informations Widget) \\
\hline
19 & 2 & Teambesprechung \\
   & 1 & Frontend dev (Widget buttons) \\
\hline
